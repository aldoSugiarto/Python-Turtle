...
fixed_game_0 = [['Stack 1', 'Suit A', 5, 0]]
...
fixed_game_8 = [['Stack 1', 'Suit A', 2, 0],
                ['Stack 2', 'Suit B', 3, 0],
                ['Stack 3', 'Suit C', 1, 0],
                ['Stack 4', 'Suit D', 1, 0]]
...
def deal_cards(game_type):
    ...
    for all_elements in game_type :
        ...
        #*****************************#
        #*********** IF 1 ************#
        if game_type[index][0] == 'Stack 1' :
            for paint in range(game_type[0][2]) :
                goto(position[0])
                if game_type[0][1] == 'Suit A':
                    basketball()
                    position[0] += offset
                elif game_type[index][1] == 'Suit C':
                    bowlingball()
                    position[0] += offset
                        
        elif game_type[index][0] == 'Stack 3' :
            for draw in range(game_type[index][2]) :
                goto(position[2])
                if game_type[index][1] == 'Suit D':
                    soccerball()
                    position[2] += offset

        #*****************************#
        #*********** IF 2 ************#
        if game_type[index][0] == 'Stack 2' :
            for draw in range(game_type[index][2]) :
                goto(position[1])
                if game_type[index][1] == 'Suit B':
                    tennisball()
                    position[1] += offset

        elif game_type[index][0] == 'Stack 5' :
            for draw in range(game_type[index][2]) :
                goto(position[4])
                if game_type[index][1] == 'Suit D':
                    soccerball()
        ...
        elif game_type[index][0] == 'Stack 6' :
            for draw in range(game_type[index][2]) :
                goto(position[5])
                if game_type[index][1] == 'Suit B':
                    tennisball()
        ...
        if game_type[index][0] == 'Stack 1' :
            for draw in range(game_type[index][2]) :
                goto(position[0])
                if game_type[index][1] == 'Suit C':
                    bowlingball()
                    position[0] += offset

        elif game_type[index][0] == 'Stack 2' :
            for draw in range(game_type[index][2]) :
                goto(position[1])
                if game_type[index][1] == 'Suit A':
                    basketball()
        ...
        elif game_type[index][0] == 'Stack 4' :
            for draw in range(game_type[index][2]) :
                goto(position[3])
                if game_type[index][1] == 'Suit D':
                    soccerball()
...
deal_cards(fixed_game_15) # <-- used for code development only, not marking
